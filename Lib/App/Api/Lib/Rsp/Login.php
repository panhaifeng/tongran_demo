...
class Api_Lib_Rsp_Login extends Api_Response {
    function Api_Lib_Rsp_Login(){
    ...
    */
    function getMenu($params = array(),& $service){
        ...
        $_menu = array(
            array('itemId'=>'outPut','id'=>'159','title'=>'产量登记'),
            array('itemId'=>'process','id'=>'160','title'=>'订单进度报表'),
            array('itemId'=>'orderData','id'=>'158','title'=>'首页数据'),
            array('itemId'=>'demo1','id'=>'2020-3','title'=>'固定高度'),
        );
