...
<table width="80%">
  ...
  <tr>
  <td>标记完成：</td>
  <td><input type='checkbox' id='isCom' name='biaoji' value='1' {if $aRow.Vat.hsOver}checked{/if} onclick='isComplete(this)' /></td> <!---->
  </tr>
