...
<div align="center">
<table width="100%" border="1" style="width:100p%">
                <tr class="th">
                ...
                <tr>
                  ...
                  <td align="center"><input name="netWeight[]" type="text" id="netWeight[]" value="{$item.netWeight}" size="10"></td>
                  ...
                  <td align="center" nowrap><input name="cntK[]" type="text" id="cntK[]" value="{$item.Gang.cntPlanTouliao}" size="10" onChange="getCnt(this)">
                  <input name="cntPlanTouliao[]" type="hidden" id="cntPlanTouliao[]" value="{$item.Gang.cntPlanTouliao}"></td>
                  <td align="center">
                    <select  name ="carId[]" id="carId[]" onchange="ChangeCarId(this)">
                    {webcontrol type='TmisOptions' model='jichu_vehicle' selected=$item.carId }
                    </select>
