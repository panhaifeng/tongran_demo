...
<fieldset>
<legend>本厂采购入库基础资料</legend>
<table class="tableHaveBorder table100" width="100%">
<tr>
	<td height="25" class="tdTitle">入库单号：</td>
	<td><input name="ruKuNum" type="text" id="ruKuNum" value="{$aRow.ruKuNum}" size="15" warning="请输入单号!" check="^\w+$" >
	&nbsp;&nbsp;</td>
	<td class="tdTitle">送货单号： </td>
	<td><input name="songhuoCode" type="text" id="songhuoCode" value="{$aRow.songhuoCode}" size="15" ></td>
</tr>

<tr>
	<td class="tdTitle">坯纱供应商：</td>
	<td>
		<select name="supplierId" id="supplierId" warning='请选择'>
...
<input type="hidden" name="id2[]" id="id2[]" value="{$item.id}">
	...
	<tr>
	  ...
	  <td align="center"><input name="pihao[]" type="text" id="pihao[]" value="" size="8"></td>
	  <td align="center"><input name="chandi[]" type="text" id="chandi[]" size="8" value="无"></td>
