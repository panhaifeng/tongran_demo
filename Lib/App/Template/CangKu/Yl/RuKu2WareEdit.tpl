...
$(function(){
	$('#btnAddRow').click(function(){
		var tr = document.getElementById('aRow');
		for (var i=0;i<5;i++) {
...
<table class="tableHaveBorder table100" width="100%">
	...
	<tr>
	  ...
	  <td align="center">{$item.danjia*$item.cnt}</td>
...
<div id="footButton" style="width:300px;">
	<ul>
		<li><input name="Back" type="button" id="Back" value='确定并返回' onClick="javascript:window.location.href='{url controller=$smarty.get.controller action='right'}'">
		</li>
	</ul>
</div>
