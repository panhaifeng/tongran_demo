...
<table width="667" height="404" border="0" cellpadding="0" cellspacing="0">
			...
			<table width="428" height="27" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td valign="bottom" style="background-image:url(Resource/Image/Login/systemName_bg.gif); width:294px; height:27px; color:#33689e; font-size:20px;">
						{webcontrol type='GetAppInf' varName='systemName'}&nbsp;<span style="font-size:12px;">v3.7</span>
					</td>
				</tr>
			</table>
		</td>
			...
			<table width="428" height="173" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<form name="login" id="login" method="post" action="?controller=Login&action=Login">
						<table>
							<tr>
								<td>用户名<span style="font-weight:bold">:</span></td><td align="left"><input type="text" name="username" id="username" value="" style="width:100px;" tabindex="1"/></td>
							</tr>
							
							<tr>
								<td>密&nbsp;&nbsp;&nbsp;码<span style="font-weight:bold">:</span></td>
								<td align="left"><input type="password" name="password" id="password" value="" style="width:100px;" tabindex="2"/></td>
							</tr>
							
							<tr>
								<td>模&nbsp;&nbsp;&nbsp;式<span style="font-weight:bold">:</span></td>
								<td align="left"><select name="loginModel">
									<option value=1>标准模式</option>
									<option value=2>查看模式</option>
								</select></td>
							</tr>
							
							<tr style="height:50px;">
								<td colspan="2"><input name="login" type="submit" class="button" value=" 登 陆 " tabindex="3"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="reset" type="reset" class="button" value=" 重 置 " tabindex="4"/></td>
							</tr>
						</table>
					</form>
					</td>
	...
	<tr>
		<td background="Resource/Image/Login/Login_03_13.jpg" width="428" height="15" style="font-size:11px; font-weight:normal;" align="right">技术支持：<a href="http://www.eqinfo.com.cn">常州易奇信息科技有限公司</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="5">
