...
<div style=" clear:both; width:800px; text-align:center">
	<ul style="list-style:none; margin:0; padding:0px;">
		...
		<li style="margin:0 auto; width:480px;padding-top:10px;padding-bottom:10px; font:12px Arial, Helvetica, sans-serif;">&copy;2009 - 2010 {webcontrol type='GetAppInf' varName='compName'}     ( 技术支持 <a href="http://www.eqinfo.com.cn">常州市易奇信息科技有限公司</a> )</li>
  </ul>
</div><!-----bottom end----------->
</div>
</body>
