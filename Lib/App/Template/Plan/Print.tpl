...
{* 	table_with:表宽		
	...
	tr_height:其它行高度 	
*}	
<body style="text-align:center" onafterprint="return window_onafterprint()" 
...
<div id='prn' align='center'><input language=javascript id=prnbutt onClick="return prnbutt_onclick()" type=button value="打印"></div>
</body>
</html>
