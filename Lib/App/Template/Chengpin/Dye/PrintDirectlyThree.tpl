...
function CreatePrintPage(obj,cp,tp){
	...
	for(var i=0;i<perPage+2;i++) {
		LODOP.ADD_PRINT_LINE(60+26*i,14,59+26*i,780,0,1);
	}	
	...
	LODOP.ADD_PRINT_LINE((perPage+1)*26+58,780,59,780,0,1);
	...
	LODOP.SET_PRINT_STYLEA(0,"Alignment",2);*/
	LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-4);
	LODOP.ADD_PRINT_TEXT(59,530,58,25,"出库数量");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
	LODOP.SET_PRINT_STYLEA(0,"Alignment",2);

	LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-4);
	LODOP.ADD_PRINT_TEXT(59,595,58,25,"染色单价\n元/kg"); 
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
	LODOP.SET_PRINT_STYLEA(0,"Alignment",2);

	LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-4);
	LODOP.ADD_PRINT_TEXT(59,654,68,25,"类别");   
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
	LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
    LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-4);
	LODOP.ADD_PRINT_TEXT(66,718,68,20,"小计金额");  
	LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
	LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
	...
	for(var i=0;obj.Gang[i];i++) {
		...
		LODOP.SET_PRINT_STYLEA(0,"Alignment",2);*/
		LODOP.ADD_PRINT_TEXT(93+26*i,528,67,20,obj.Gang[i].cntChuku);//出库数量  
		LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
		LODOP.ADD_PRINT_TEXT(93+26*i,591,67,20,' '); 
		LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
		LODOP.ADD_PRINT_TEXT(93+26*i,655,67,20,obj.Gang[i].kindName);  
		LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
		LODOP.ADD_PRINT_TEXT(93+26*i,716,67,20,' ');  
		LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
		// LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
		// LODOP.SET_PRINT_STYLEA(0,"Italic",0);
