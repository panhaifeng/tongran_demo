...
<input name="dateFrom" type="text" id="dateFrom" value="{$smarty.post.dateFrom|default:$smarty.now|date_format:'%Y-%m-%d'}" size="10" onClick="calendar()">
                      截至日期：
...
{webcontrol type='TmisOptions' model='JiChu_Employ' condition='depId=11' selected=$smarty.post.traderId|default:$smarty.get.traderId}
