...
<input name="dateFrom" type="text" id="dateFrom" value="{$smarty.post.dateFrom|default:$smarty.now|date_format:'%Y-%m-01'}" size="10" onClick="calendar()">
                      ...
                      分类(<a href="Documents/Caiwu/SupplierCode.txt" target="_blank">分类说明</a>)
                      ：
              <input name="compCode" type="text" id="compCode" size="2" value="{$smarty.post.compCode|default:$smarty.get.compCode}">
