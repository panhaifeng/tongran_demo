...
function writeIframe()
{
    ...
    "    </td><td align=center valign='top'><input name=today type=button value='今天' onfocus='this.blur()' style='width: 50' title='当前日期&#13;快捷键：T'"+
...
var TmisCalendar = function() //初始化日历的设置
{
    ...
    this.iframe     = document.getElementById("meizzCalendarIframe").contentWindow; //日历的 iframe 载体
...
{	
    var e = document.all ? window.event.srcElement : e.target;   writeIframe();
