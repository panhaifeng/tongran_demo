...
class Api_ResponseMini {
    ...
    */
    function response() {
        ...
        $this->timeR2 = microtime_float();

        $result_json = array(
            'rsp'      => $status ? $status : 'succ',
            'data'     =>$result,
            'res'      =>strip_tags($output),
            'res_time' =>($this->timeR2 - $this->timeR1),
        );
    ...
    */
    ...
    public function send_user_error($code, $data = array()) {
        $this->end();
        $res = array(
            'rsp'   =>  'fail',
            'res'   =>  $code,
        ...
        $this->timeR2 = microtime_float();
        $res['res_time'] = $this->timeR2 - $this->timeR1;
