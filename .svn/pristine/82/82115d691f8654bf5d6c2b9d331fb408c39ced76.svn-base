...
<table width="100%" border="0" cellpadding="1" cellspacing="1" id="tb">  
  ...
  <tr>
   ...
   <tr id="fieldInfo">
    ...
    <td bgcolor="#6699cc" width="90px">款号</td>
    <td bgcolor="#6699cc">颜色</td>
    ...
    <td bgcolor="#6699cc">单价</td>
    <td bgcolor="#6699cc">小缸价</td>
 ...
 {foreach from=$aOrder.Ware item='aOrdPro' key=key}
  ...
  <tr>
    ...
    <td class="mm">{$item.danjia}</td>
    <td class="mm">{$item.money}</td>
