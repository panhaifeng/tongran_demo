...
<form name="form1" id="form1" action="{url controller=$smarty.get.controller action='save'}" method="post" AutoComplete='off'>
  ...
  <tr>
    <td align="right" class="tdTitle1">入库日期</td>
    <td align="left"><input name="dateRuku" type="text" id="dateRuku" onClick="calendar()" value="{$aRow.dateRuku|default:$smarty.now|date_format:'%Y-%m-%d'}"></td>
  </tr>
  <tr>
...
<tr>
  <td align="right" class="tdTitle1">单价</td>
  <td align="left"><input name="danjia" type="text" id="danjia" value="{$aRow.danjia}" /></td>
</tr>
<tr>
