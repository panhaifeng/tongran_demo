...
jQuery.fn.extend({
    ...
    //设置方向键的方法，
    direct:function(_select){
            if(_select==undefined)_select=false;
            var tabName=this;
            //设置方向键的问题
            $(tabName).each(function(pos){
                $('[name="'+this+'"]').live('keydown',function(e){
                    ...
                    if(e.keyCode==38){
                        ...
                        //如果是select的向下，需要屏蔽
                        if(p<1)return false;
                        if(objs[p-1].type=='select-one') {
                            return true;
                        }
                        if(objs[p-1]){
                            if(_select===false)objs[p-1].focus();
                            else objs[p-1].select();
                        }
                        return false;
                        ...
                        if(e.keyCode==40 && objs[p+1].type=='select-one') {
                            return true;
                        }
                        if(objs[p+1]){
                            if(_select===false)objs[p+1].focus();
                        ...
                        if(_select===false)_objs[p].focus();
                        else _objs[p].select();
                        return false;
