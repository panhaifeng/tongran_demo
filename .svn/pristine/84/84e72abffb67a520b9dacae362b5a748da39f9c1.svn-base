...
function CreatePrintPage(obj,offsetX,offsetY) {
	...
	LODOP.ADD_PRINT_TEXT(89,75,121,20,"染化料/助剂");
	LODOP.ADD_PRINT_TEXT(89,197,150,20,"单位用量");
	LODOP.ADD_PRINT_TEXT(89,345,70,20,"缸用量");
	LODOP.ADD_PRINT_TEXT(89,414,59,20,"温度");
	LODOP.ADD_PRINT_TEXT(89,473,59,20,"时间");
	LODOP.ADD_PRINT_TEXT(89,527,59,20,"备注");
	...
	for(var i=0;obj.Dye[i];i++) {
		...
		LODOP.ADD_PRINT_TEXT(112+24*i,75,121,20,obj.Dye[i].guige);
		LODOP.ADD_PRINT_TEXT(112+24*i,197,150,20,obj.Dye[i].unitKg);
		LODOP.ADD_PRINT_TEXT(112+24*i,345,70,20,''+(obj.Dye[i].cntKg||''));
		LODOP.ADD_PRINT_TEXT(112+24*i,414,59,20,obj.Dye[i].tmp);
		LODOP.ADD_PRINT_TEXT(112+24*i,473,59,20,obj.Dye[i].timeRs);
		LODOP.ADD_PRINT_TEXT(112+24*i,527,59,20,obj.Dye[i].memo);
	}

        //增加竖线
		LODOP.ADD_PRINT_LINE(350,70,85,71,0,1);
		LODOP.ADD_PRINT_LINE(350,194,85,195,0,1);
		LODOP.ADD_PRINT_LINE(350,526,85,527,0,1);
		LODOP.ADD_PRINT_LINE(350,341,85,342,0,1);
		LODOP.ADD_PRINT_LINE(350,630,85,631,0,1);
		LODOP.ADD_PRINT_LINE(350,412,85,413,0,1);
		LODOP.ADD_PRINT_LINE(350,588,85,589,0,1);
		LODOP.ADD_PRINT_LINE(350,468,85,469,0,1);
		LODOP.ADD_PRINT_LINE(350,677,85,678,0,1);
