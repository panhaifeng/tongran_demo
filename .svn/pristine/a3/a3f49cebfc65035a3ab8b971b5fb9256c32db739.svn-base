...
(function(b) {
    var a = {
        settings: {
            ...
            color: "#000000",
            fontSize: 10,
			letterSpacing: 1,//字间距 by zcc 新增
			fontWeight: false,// 字体是否加粗 by zcc 新增
            output: "css",
            posX: 0,
            posY: 0
        },
        ...
        digitToCssRenderer: function(q, d, m, e, p, g) {
            ...
            if (d.showHRI) {
                j += '<div style="clear:both; width: 100%; background-color: ' + d.bgColor + "; color: " + d.color + "; text-align: center; font-size: " + d.fontSize + "px; margin-top: " + d.marginHRI + "px; letter-spacing:" + d.letterSpacing +  "px; font-weight:" + d.fontWeight + '">' + e + "</div>"
            }
