...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td>客户：{webcontrol type='ClientSelect' selected=$aRow.Client arType=2}</td>
    </tr>
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="2">
      <tr>
        <td align="center">缸次</td>
  ...
  <tr>
	...
	<input name="arTypeId" type="hidden" id="arTypeId" value="2" />
