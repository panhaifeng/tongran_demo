...
class Controller_CangKu_Tuiku extends Tmis_Controller {
	var $_modelChuku;
	var $funcId;
    var $rukuTag;
	function Controller_CangKu_Tuiku() {
	...
	function actionRight(){
		FLEA::loadClass('TMIS_Pager');
			...
			left join jichu_ware z on x.wareId=z.id where 1 and x.isTuiku=1 ";
		...
		$arrFieldInfo = array(
			...
			//'money' => '金额'
                ...
                // $arrFieldInfo['cntReturn'] = '退库数量';
		//$arr_edit_info = array("ViewMore" =>"查看详细");
	...
	function actionRight(){
		...
		$str = "select
				...
				where 1 and x.isTuiku=1 and x.kind = 0";
	...
	function _edit() {
		...
		$smarty->display('CangKu/RukuTuihuoEdit.tpl');
	}
